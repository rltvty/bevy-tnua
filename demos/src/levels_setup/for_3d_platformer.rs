...
pub fn setup_level(
    ...
    for (i, y) in [2.0, 4.5].into_iter().enumerate() {
        ...
        cmd.insert(PbrBundle {
            ...
            transform: get_transform(Vec3::new(6.0, y, 10.0), is_spherical),
            ..Default::default()
        });
        #[cfg(feature = "rapier3d")]
        {
    ...
    commands.spawn((
        ...
        SceneBundle {
            ...
            transform: get_transform(Vec3::new(10.0, 2.0, 1.0), is_spherical), // .with_scale(0.01 * Vec3::ONE),
            ..Default::default()
        },
        #[cfg(feature = "rapier3d")]
        (
    ...
    commands.spawn((
        ...
        SceneBundle {
            ...
            transform: get_transform(Vec3::new(15.0, 2.0, 1.0), is_spherical), // .with_scale(0.01 * Vec3::ONE),
            ..Default::default()
        },
        rapier::Collider::cuboid(2.0, 1.0, 2.0),
        SolverGroups {
    ...
    commands.spawn((
        ...
        SceneBundle {
            ...
            transform: get_transform(Vec3::new(20.0, 2.0, 1.0), is_spherical), // .with_scale(0.01 * Vec3::ONE),
            ..Default::default()
        },
        #[cfg(feature = "rapier3d")]
    ...
    // Spawn moving platform
    {
        ...
        cmd.insert(PbrBundle {
            ...
            transform: get_transform(Vec3::new(-4.0, 6.0, 0.0), is_spherical),
            ..Default::default()
        });
        #[cfg(feature = "rapier3d")]
        {
    ...
    {
        let transform = get_transform(Vec3::new(-2.0, 2.0, 10.0), is_spherical);
